            ...
            <div className="homePage__content">
              <div className="box">
                <div className="box__content">
                  <Image className="box__image" src={colorWheel} priority loading="eager" alt="image de roue" width={250} height={250} />
                  <h2>Picker Wheel</h2>
              ...
              <div className="box">
                <div className="box__content">
                  <Image className="box__image" src={coin} priority loading="eager" alt="image de pièce" width={250} height={250} />
                  <h2>Pile ou Face</h2>
